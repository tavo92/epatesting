...
calculateEffectSize <- function() {
	for(subj in subjects) {
			...
			cat("evosuite_default vs. evosuite_epamixed","\n")
        	        cat("\n")

			cat("summary pit_score_default")
        	        cat("\n")
			cat("Min. 1st Qu. Median Mean 3rd Qu. Max.","\n")
			cat(summary(pit_score_default))
        	        cat("\n")

			cat("summary pit_score_epamixed")
        	        cat("\n")
			...
			cat("length(pit_score_default)=", length(pit_score_default), "\n")
			cat("length(pit_score_epamixed)=", length(pit_score_epamixed), "\n")
