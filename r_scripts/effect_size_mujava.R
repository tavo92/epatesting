...
calculateEffectSize <- function() {
	for(subj in subjects) {
			...
			default_errors = default_rows$MJMUT
			...
			epatransition_errors = epatransition_rows$MJMUT
			...
			line_branch_epatransition_errors = epatransition_rows$MJMUT
			...
			epaexception_errors = epaexception_rows$MJMUT
			...
			line_branch_epaexception_errors = line_branch_epaexception_rows$MJMUT
			...
			line_branch_edges_errors = line_branch_edges_rows$MJMUT
			...
			line_branch_tran_except_edges_errors = line_branch_tran_except_edges_rows$MJMUT
