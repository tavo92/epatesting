...
calculateEffectSize <- function() {
	for(subj in subjects) {
			...
			line_branch_errors = default_rows$MJMUT
			...
			epatransition_epaexception_errors = epatransition_epaexception_rows$MJMUT
			...
			line_branch_exception_epatransition_epaexception_errors = line_branch_exception_epatransition_epaexception_rows$MJMUT
